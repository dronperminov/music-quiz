...
from src.api import analytics, api, artists, artists_groups, auth, multi_player, notes, questions, quiz_tours, settings, tracks
...
def init_routers() -> None:
    ...
    app.include_router(artists_groups.router)
