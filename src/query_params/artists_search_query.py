...
class ArtistsSearchQuery:
    ...
    def is_empty(self) -> bool:
        feilds = [
            self.query, self.target, self.order, self.order_type, self.listen_count, self.years, self.tracks_count, self.added_tracks, self.genres,
            self.artist_type, self.artists_count, self.language
        ]
